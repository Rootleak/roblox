...
local Library do
    ...
    Library.GetIcon = function(self, IconName)
        ...
        if not isfile(filePath) then
            ...
            if not success then
                warn("[Stalkie] Failed to download icon '" .. IconName .. "': " .. tostring(err))
                return "rbxassetid://116339777575852" -- Fallback on download failure
            end
        end
        
        -- Return local asset with error handling
    ...
    Library.PreloadAssets = function(self, loaderElements, callback)
        ...
        task.spawn(function()
            local totalIcons = 0
            for _ in pairs(self.Icons) do
                totalIcons = totalIcons + 1
            end
            
            local downloaded = 0
            
            for iconName, iconData in pairs(self.Icons) do
                local fileName = iconData[1]
                local githubUrl = iconData[2]
                local filePath = self.Folders.Assets .. "/" .. fileName
                ...
                if not isfile(filePath) then
                    ...
                    if not success then
                        warn("[Stalkie] Failed to preload icon '" .. iconName .. "': " .. tostring(err))
                    end
                end
    ...
    do -- Element functions
        ...
        Library.Window = function(self, Data)
            ...
            local Items = { } do
                ...
                Library.CustomMouseEnabled = true
                ...
                Library:Connect(RunService.RenderStepped, function()
                    ...
                    if Library.CustomMouseEnabled then
                        Items["MouseImage"].Instance.Visible = Window.IsOpen
        ...
        Library.Pages.Playerlist = function(self, Data)
            ...
            local Items = { } do
                ...
                -- Left column: toggle (top) + teleport button (bottom)
                ...
                Items["SpectateToggle"] = Instances:Create("TextButton", {
                    ...
                    BorderSizePixel = 0, Size = UDim2New(1, 0, 0, 24),
                    Position = UDim2New(0, 0, 0, 0),
                    ZIndex = 2, TextSize = 13,
                    BackgroundColor3 = FromRGB(255, 255, 255)
                })
                ...
                Items["SpectateToggle"]:OnHover(function()
                    if Items["SpectateToggle"].SpectateActive then return end
                ...
                -- Teleport button: exact library button style, anchored to bottom of left column
                Items["TeleportBtn"] = Instances:Create("TextButton", {
                    ...
                    AutomaticSize = Enum.AutomaticSize.X,
                    Size = UDim2New(0, 0, 0, 24), ZIndex = 2, TextSize = 13,
                    BackgroundColor3 = FromRGB(34, 39, 45)
                ...
                Instances:Create("TextLabel", {
                    ...
                    Size = UDim2New(0, 0, 1, 0), ZIndex = 2, TextSize = 13,
                    BackgroundColor3 = FromRGB(255, 255, 255)
                }):AddToTheme({TextColor3 = "Text"})
            ...
            do -- Status dropdown inside right column
                local DropdownItems = { } do
                    DropdownItems["Dropdown"] = Instances:Create("Frame", {
                        Parent = Items["ControlsRight"].Instance,
                        Name = "\0",
                        BackgroundTransparency = 1,
